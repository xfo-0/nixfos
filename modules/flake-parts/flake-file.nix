    ...
    inputs = {
      flake-file = {
        ...
        clone = {
          ...
          aliases = [
            "github.com/vic/flake-file"
            "github.com/xfo-0/flake-file"
          ];
        };
      };
      ...
      den = {
        url = "gh:sini/den/feat/entity-gen-schema-port";
        clone = {
          enable = true;
          tags = [
            "den"
          ...
          aliases = [
            "github.com/vic/den"
            "github.com/denful/den"
          ];
          note = "den framework; riding feat/entity-gen-schema-port (sini)";
        };
      };
      nh = {
        url = "gh:xfo-0/nh/b7bd1a7d9a6ecd7bf348d4cde63102e93c29a44f";
        clone = {
          enable = true;
          tags = [ "own" ];
          note = "nh deploy soft-fork until sini/nh#1 merges";
        };
      };
      gen-algebra = {
        url = "gh:sini/gen-algebra/49f6721bd314b38272bd6b1b26139569365c85a6";
        clone = {
          enable = true;
          tags = [
            "den"
      ...
      gen-schema = {
        url = "gh:sini/gen-schema/c072f76be4164a854312b892867c2d007891575a";
        clone = {
          enable = true;
          tags = [
            "den"
      ...
      scope-engine = {
        url = "gh:sini/scope-engine/7e301a5b0372a554ad1f57b080a9a8918f483ff8";
        clone = {
          enable = true;
          tags = [ "den" ];
        };
