  ...
  den.aspects.browser.floorp = {
    ...
    homeManager =
      ...
      let
        ...
        # rycee pin lags AMO; the pinned buster 3.1.0 .xpi was deleted upstream. Pin 3.2.0 directly.
        buster-captcha-solver = addons.buster-captcha-solver.overrideAttrs (_: {
          name = "buster-captcha-solver-3.2.0";
          version = "3.2.0";
          src = pkgs.fetchurl {
            url = "https://addons.mozilla.org/firefox/downloads/file/4841979/buster_captcha_solver-3.2.0.xpi";
            hash = "sha256-FwESrTV6KYxIJzEXrgB6VDPeoSRORy7tDmRHW4YkUW0=";
          };
        });
        forceInstall = slug: {
