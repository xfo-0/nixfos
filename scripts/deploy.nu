...
def main [
  ...
  --xfo-key: string    # optional path to xfo's id_ed25519 to seed for first-boot user sops
] {
  ...
  if ($xfo_key != null) {
    mkdir $"($tree)/home/xfo/.ssh"
    cp $xfo_key $"($tree)/home/xfo/.ssh/id_ed25519"
    chmod 600 $"($tree)/home/xfo/.ssh/id_ed25519"
  }
